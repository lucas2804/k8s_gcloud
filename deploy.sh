docker build -t lucdang/multi-client:latest -t lucdang/multi-client -f ./client/Dockerfile ./client
docker build -t lucdang/multi-server:latest -t lucdang/multi-server -f ./server/Dockerfile ./server
docker build -t lucdang/multi-worker:latest -t lucdang/multi-worker -f ./worker/Dockerfile ./worker
